...
# Load origin dataset
num_molecules_in_cell = 400
train_data = scio.loadmat(f'../data/Noise_sensitivity/Diffusion_flow_num_molecules_in_cell_{num_molecules_in_cell}.mat')
rho = train_data['rho']
...
output_type = f'Diffusion_equation_DHC-GEP_noise_sensitivity_analysis_{num_molecules_in_cell}'     # Name of the problem
...
if isRestart:
    with open(f"pkl/real-time_Diffusion_eauqtion_DHC-GEP_noise_sensitivity_analysis_{num_molecules_in_cell}.pkl",'rb') as file:
