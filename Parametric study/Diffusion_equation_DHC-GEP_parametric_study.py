...
output_type = 'Diffusion_equation_DHC-GEP_parametric_study'     # Name of the problem
...
if isRestart:
    with open("pkl/real-time_Diffusion_eauqtion_DHC-GEP_parametric_study.pkl",'rb') as file:
