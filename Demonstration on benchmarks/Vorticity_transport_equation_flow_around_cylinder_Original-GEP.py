...
output_type = 'Vorticity_transport_equation_flow_around_cylinder_Original-GEP'     # Name of the problem
...
if isRestart:
    with open("pkl/real-time_Vorticity_transport_equation_flow_around_cylinder_Original-GEP.pkl",'rb') as file:
