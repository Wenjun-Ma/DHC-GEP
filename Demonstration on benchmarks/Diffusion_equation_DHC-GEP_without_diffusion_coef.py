...
Lambda = 6.2497e-08 # Diffusion coefficient
tau = 1.644e-10 # Viscosity coefficient
...
pset.add_symbol_terminal('lam', Lambda)
pset.add_symbol_terminal('tau', tau)
...
n_gen = 101             # Maximum Generation
tol = 1e-3               # Threshold to terminate the evolution
output_type = 'Diffusion_equation_DHC-GEP_without_diffusion_coef'     # Name of the problem
...
if isRestart:
    with open("pkl/real-time_Diffusion_eauqtion_DHC-GEP_without_diffusion_coef.pkl",'rb') as file:
