...
diffusion_coef = 2.468e-05 # Diffusion coefficient
...
output_type = 'Diffusion_equation_DHC-GEP'     # Name of the problem
...
if isRestart:
    with open("pkl/real-time_Diffusion_eauqtion_DHC-GEP.pkl",'rb') as file:
